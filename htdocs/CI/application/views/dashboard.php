...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="min-height:960px ;">
    ...
    <div class="row" style="padding: 20px 20px 20px 20px">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number tmakanan"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-yellow"><i class="ion ion-ios-wineglass-outline"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">Stock Minuman</span>
              <span class="info-box-number tminuman"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
    ...
    <div class="row" style="padding: 20px 20px 20px 20px">
     ...
     <div class="row" style="padding: 20px 20px 20px 20px">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Persebaran Pengguna Twitter</h3>
              ...
              <div class="box-body no-padding">
                <iframe width="100%" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiMDc0MjU1MTctNzcyNC00M2M4LThiYzYtM2E1ZjJiNTAzY2QwIiwidCI6IjI4MGRhZjUyLTEzZjYtNDc1ZS1hNDJhLThhNzUxNzU5Zjk3YSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>               
              <!-- /.row -->
            </div>
            </div>
            <!-- /.box-header -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><i class="ion ion-social-twitter-outline"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">Pengguna twitter</span>
              <span class="info-box-number twitter"><small> </small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="row" style="padding: 20px 20px 20px 20px">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Market Basket Analysis</h3>
              ...
              <div class="box-body no-padding">
                <iframe width="800" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiMGYwNjYyZmQtYjUwZS00ZWIxLWE4YjUtNjU5NTRkYmMxMjRjIiwidCI6IjI4MGRhZjUyLTEzZjYtNDc1ZS1hNDJhLThhNzUxNzU5Zjk3YSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
              <!-- /.row -->
            </div>
            </div>
            <!-- /.box-header -->
