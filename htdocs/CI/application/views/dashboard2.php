  ...
  <div class="content-wrapper" style="min-height:960px ;">
    ...
    <div class="row" style="padding: 20px 20px 20px 20px">
        <div class="col-md-6">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Stock Makanan</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Stock Minuman</h3>
    ...
    <div class="row" style="padding: 20px 20px 20px 20px">       
        <div class="col-md-8">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Produk Terjual</h3>

              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="refresh"><i class="fa fa-refresh"></i>
                </button>                
              </div>
              <div class="box-body no-padding">
                <div id="chart-container">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <div class="box-body clearfix">
                <button type="button" class="btn btn-default" style="width: 100%;">Senin</button>
                <button type="button" class="btn btn-primary" style="width: 100%;">Selasa</button>
                <button type="button" class="btn btn-default" style="width: 100%;">Rabu</button>
                <button type="button" class="btn btn-primary" style="width: 100%;">Kamis</button>
                <button type="button" class="btn btn-default" style="width: 100%;">Jumat</button>
                <button type="button" class="btn btn-primary" style="width: 100%;">Sabtu</button>
                <button type="button" class="btn btn-default" style="width: 100%;">Minggu</button>
