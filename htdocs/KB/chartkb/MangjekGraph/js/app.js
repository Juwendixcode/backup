$(document).ready(function(){
	$.ajax({
		url: "http://localhost/Miesetan_API/API/get_produk",
		method: 'GET',
    	crossDomain: true,
    	dataType: 'jsonp',
		success: function(data) {
			...
			var chartdata = {
				...
				datasets : [
					{
						backgroundColor: ["#00a65a",'#f56979',"#2ecc71","#3498db","#95a5a6","#9b59b6","#f1c40f","#e74c3c","#34495e"],
	...
	$.ajax({
		url: "http://localhost/Miesetan_API/API/get_produk2",
		method: 'GET',
    	crossDomain: true,
    	dataType: 'jsonp',
		success: function(data) {
	...
	$.ajax({
		...
		success: function(data) {
			...
			var chartdata = {
				...
				datasets : [
					{
						label: 'Total Produk Terjual Hari '+label[0],
						fill: false,
						lineTension: .5,
