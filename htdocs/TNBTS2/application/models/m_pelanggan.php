...
class M_pelanggan extends CI_Model{
    ...
    function getJumlahPelangganOrder()	{
		$query = $this->db->query("
			SELECT t.start_latitude,t.start_longitude FROM transaksi t,history_transaksi h WHERE t.id=h.id_transaksi AND h.status=1");
        return $query->result_array();
    }
