        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li >
                        <a href="./C_dashboard"><span class="fa fa-pencil"></span> <span class="xn-text">Set Data</span></a>
                        <!-- <ul>
                            <li>
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                   ...
                   <!--  <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h3>Driver dan Pengguna Aktif</h3>
                        </div>
                        <div class="col-md-4">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="widget widget-default widget-item-icon" onclick="location.href='table-datatables.html';">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo $juml_pengguna[0]['jumlah']; ?></div>
                                    <div class="widget-title">Total Pengguna</div>
                                    <!-- <div class="widget-subtitle"> -->
                                    <table>
                                        <thead>
                                        </thead>
                                        <tbody>
                                                <tr>
                                                    <td><div class="widget-subtitle"><span class="label label-success">&nbsp;&nbsp; &nbsp; Aktif &nbsp; &nbsp;</span></div></td>
                                                    <td>&nbsp; = <?php echo $juml_pengguna1[0]['jumlah']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><div class="widget-subtitle"><span class="label label-warning">Non-aktif</span></div></td>
                                                    <td>&nbsp; = <?php echo $juml_pengguna2[0]['jumlah']; ?></td>
                                                </tr>                                                
                                                <tr>
                                                    <td><div class="widget-subtitle"><span class="label label-danger">&nbsp;&nbsp;Banned&nbsp;</span></div></td>
                                                    <td>&nbsp; = <?php echo $juml_pengguna3[0]['jumlah']; ?></td>
                                                    <!-- <td>
                                                        <div class="progress progress-small progress-striped active">
                                                            <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 72%;">72%</div>
                                                        </div>
