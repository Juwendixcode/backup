        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                <div class="box box-success">
                    ...
                    <form role="form" action="<?php echo site_url('info_tebu/'.$action)?>" method="get">
                         <div class="form-group">
                          ...
                          <?php echo $input_tanggal;?>
                           <div class="box-body">
                            ...
                            <label>Fisik Batang</label>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <input type="text" class="form-control" placeholder="Diameter(cm)" name="diameter" required>
                                    </div>
                                    <div class="col-xs-6">
                                        <input type="text" class="form-control" placeholder="tinggi(m)" name="tinggi" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <input type="text" class="form-control" placeholder="berat(kg)" name="berat" required>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        </div><!-- /.box-body -->
